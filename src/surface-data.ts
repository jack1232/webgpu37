...
export const SimpleSurfaceData = (f:any, xmin:number, xmax:number, zmin:number, zmax:number, 
    nx:number, nz:number, scale = 1, scaley = 0, colormapName = 'jet', center:vec3 = [0,0,0], ul = 1, vl = 1) => {
...
const CreateQuad = (p0:vec3, p1:vec3, p2:vec3, p3:vec3, ymin:number, ymax:number, colormapName:string, scale = 1, ul = 1, vl = 1) => {
    let vertex = [] as any, normal = [] as any, color = [] as any;
